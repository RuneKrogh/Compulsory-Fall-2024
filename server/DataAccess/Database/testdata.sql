...
INSERT INTO customers (name, address, phone, email) VALUES
    ('Admin User', '1 Admin Lane, Test City, Test Country', '+1-555-000-0000', 'admin@example.com');

-- Insert 49 additional customers with varied locations
INSERT INTO customers (name, address, phone, email) VALUES
('John Doe', '123 Elm St, New York, USA', '+1-555-123-4567', 'john.doe@example.com'),
...
('Nancy Johnson', '3838 Oak St, Sarajevo, Bosnia and Herzegovina', '+387 33 123 456', 'nancy.johnson@example.com'),
